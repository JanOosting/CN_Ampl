...
#outputFileTable="/home/wplugge/R/additional.pool/453/453_CNV_analysis.txt" # Not necessary, overview table is also saved in html
pool.coverage=read.table("/home/wplugge/R/additional.pool/452/base.coverage.panel_452.txt")
#pool.coverage=read.table("/home/wplugge/R/additional.pool/453/base.coverage.panel_453.txt")
...
```{r print_result_table, echo=FALSE, warning=FALSE, results = 'asis'}
...
CNV.table=CI %>% 
  ...
  filter(!CNV=="NA") %>%
  select(sample, amplicon, sample.consider, quant.smooth, final_LCI, final_UCI, CNV)
