...
#  x_density_threshold=0.3  
#} else {
#  # List with positions is used as index numbers to retrieve corresponding y_density values. To achieve this, a start position (1) #     and end position (nrow(y_density)) are added to this list.
