...
# amplFile=/home/wplugge/R/additional.pool/nu_CHP2.primer.bed # pool 433, 438, 439, 
...
outputFileTable="/home/wplugge/R/additional.pool/452/452_CNV_analysis.txt"
...
for (i in 2:nrow(y_density)){ # first number cannot be compared with previous number
  print(y_density$Y[i])
  print(c("hallo", y_density$Y[i-1]))
  
  y_density$test[i]=ifelse(y_density$Y[i] >= y_density$Y[i-1], "A", "D" ) # equal to is considered ascending....
}
